              ...
              <div className="container-safe relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                  ...
                  >
                                            ...
                                            <div className="inline-flex items-center gap-2 self-center lg:self-start bg-benin-green/10 text-benin-green px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest">

                                              <Sparkles className="size-3.5" />

                                              <span>HORIZON BÉNIN — L'Avenir en Confiance</span>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
                          ...
                          <Dialog>
                            ...
                            <DialogTrigger asChild>
                              ...
                              <Button size="lg" className="rounded-full h-12 px-8 text-base shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all bg-benin-green hover:bg-benin-green-dark text-white">
                            ...
                            {/* Modal content handled in Header, but can be reused or linked */}
                          ...
                          <Button variant="outline" size="lg" className="rounded-full h-12 px-8 text-base border-2 hover:bg-surface-alt text-ink" asChild>
                 ...
                 {[1,2,3,4].map((i) => (
                   ...
                   <div key={i} className="w-8 h-8 rounded-full bg-gray-200 border-2 border-white flex items-center justify-center text-xs overflow-hidden">
                    ...
                    <div className="relative lg:h-[600px] w-full flex items-center justify-center">
                       ...
                       <div className="relative z-10 w-full max-w-md aspect-[4/5] bg-white rounded-[48px] overflow-hidden shadow-2xl group rotate-3 hover:rotate-0 transition-transform duration-700">
